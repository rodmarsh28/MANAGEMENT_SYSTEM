        ...
        Try
            ...
            With OleDBC
                ...
                .CommandText = "SELECT dbo.tblEmployeesInfo.employeeID,dbo.tblEmployeesInfo.lastname,dbo.tblEmployeesInfo.firstname," & _
                    ...
                    "dbo.tblEmployeesInfo.piNo,dbo.tblEmployeesInfo.Field,dbo.tblEmployeesInfo.tinNo FROM dbo.tblEmployeesInfo where EmployeeID = '" & dgw.CurrentRow.Cells(0).Value & "'"
            End With
            ...
            If OleDBDR.HasRows Then
                If OleDBDR.Read Then
                    ...
                    End If
                    tinData = OleDBDR.Item(13)
                    If tinData = "" Then
                        frmPayroll.tinNo = False
                    Else
                        frmPayroll.tinNo = True
                    End If
                    frmPayroll.clear()
                    Me.Close()
                End If
