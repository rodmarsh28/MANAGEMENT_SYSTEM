...
Public Class AllPremsSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DFCPSMASTERLIST.AllPremsSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAllPremsSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AllPremsSummary = New AllPremsSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
